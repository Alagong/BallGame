...
void Physics_FixtureBox::Init(PlayState *pState)
{
	isSensor.ValueChanged().connect(boost::bind(&Physics_FixtureBox::OnisSensorChanged,this,_1,_2));
...
void Physics_FixtureBox::Update(int delta)
{
...
void Physics_FixtureBox::Draw(sf::RenderWindow &window)
{

}

void Physics_FixtureBox::ExecuteCommand(int command, void* data)
{

}

void Physics_FixtureBox::ExecuteEvent(int event, void* data)
{
...
void Physics_FixtureBox::OnisSensorChanged(const bool &oldvalue, const bool &newValue)
{
